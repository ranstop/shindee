                ...
                <div class="row">
                    ...
                    <div class="col-md-5 col-sm-6">
                        ...
                        <div class="contact-form">
                            <form name="contactform" id="contactform" action="loginCheck.php" method="post">
                                
                                <p>
                          		<div id="errorMes"><p id="badLogin"></p> </div>
        ...
        <div class="site-footer">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="copyright">
                            <span>Copyright &copy; 2015 <a href="#">Shindee</a></span>
                        </div>
                    </div> <!-- /.col-md-4 -->
                    <div class="col-md-4 col-sm-4">
